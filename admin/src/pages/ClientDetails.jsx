      ...
      {isLogModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm animate-in fade-in duration-300">
          <div className="bg-white rounded-[32px] shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-300 flex flex-col max-h-[90vh]">
            ...
            <form className="p-8 space-y-6 overflow-y-auto custom-scrollbar" onSubmit={handleLogInteraction}>
              <div className="space-y-6">
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea 
                    ...
                    className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-bold text-slate-700 outline-none focus:border-blue-500 transition-all min-h-[100px] resize-none" 
