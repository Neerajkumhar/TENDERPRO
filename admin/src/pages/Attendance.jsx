...
const Attendance = ({ user }) => {
  ...
  const handleExportReport = () => {
    const csvRows = [
      ['Member Name', 'Member Email', 'Role', 'Date', view === 'DAY' ? 'Sessions Count' : 'Days Present', 'Clock In', 'Clock Out', 'Work Hours', 'Status'],
    ...
    downloadLink.setAttribute("download", `TenderPro_Global_Attendance_${view}_${startDate}_to_${endDate}.csv`);
