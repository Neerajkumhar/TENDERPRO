                  ...
                  <div className="col-span-12 lg:col-span-4 p-6 bg-slate-50/50 rounded-3xl border border-slate-100 space-y-6">
                    ...
                    <div className="space-y-4">
                      {[
                        ...
                        { label: 'Database Status', value: 'Connected', status: 'blue' },
                        { label: 'Server Status', value: 'Online', status: 'blue' },
                      ].map((info, i) => (
                        <div key={i} className="flex justify-between items-center">
                          <span className="text-xs font-bold text-slate-500">{info.label}</span>
                          <div className="flex items-center gap-2">
                            {info.status && <div className={`w-2 h-2 rounded-full bg-${info.status}-500 shadow-[0_0_8px_rgba(59,130,246,0.5)]`}></div>}
            ...
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="grid grid-cols-4 gap-4">
                {[
                  ...
                  { label: 'Active Now', value: '12', color: 'blue', icon: Activity },
                        ...
                        <tr key={i} className="hover:bg-blue-50/30 transition-all group">
                          ...
                          <td className="px-8 py-5">
                            <div className={`w-fit px-3 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest shadow-sm ${
                              user.status === 'Active' ? 'bg-blue-500 text-white shadow-blue-100' : 'bg-slate-300 text-white shadow-slate-100'
                            }`}>
                              {user.status}
                            </div>
                          </td>
              ...
              <div className="card p-8 bg-white border-none shadow-xl shadow-slate-200/40">
                <div className="flex justify-between items-center mb-8">
                  ...
                  <div className="flex gap-3">
                    ...
                    <span className="px-3 py-1 bg-blue-50 text-blue-600 rounded-lg text-[10px] font-black uppercase tracking-widest border border-blue-100">Server Connected</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-12 gap-6">
                  ...
                  <div className="col-span-12 lg:col-span-4 space-y-1.5">
                    ...
                    <div className="w-full h-10 bg-blue-50/50 border border-blue-100 rounded-xl flex items-center px-4 gap-2">
                      <CheckCircle2 className="text-blue-500" size={16} />
                      <span className="text-xs font-bold text-blue-600 uppercase tracking-widest">Verified</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      {isUserModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm animate-in fade-in duration-300">
          <div className="bg-white rounded-[32px] shadow-2xl w-full max-w-lg overflow-hidden animate-in zoom-in-95 duration-300">
            ...
            <form className="p-5 space-y-4" onSubmit={(e) => { e.preventDefault(); setIsUserModalOpen(false); }}>
