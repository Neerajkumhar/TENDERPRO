        ...
        <div className="flex items-center justify-center pt-2">
          <div className="bg-slate-800 p-1.5 rounded-full border border-slate-700 flex items-center gap-1">
            <button
              ...
              className={`px-5 py-2 rounded-full text-xs font-bold transition cursor-pointer ${!isYearly ? 'bg-blue-600 text-white shadow-md' : 'text-slate-400 hover:text-white'
                }`}
            >
              Monthly Billing
            </button>
            ...
            <button
              ...
              className={`px-5 py-2 rounded-full text-xs font-bold transition flex items-center gap-2 cursor-pointer ${isYearly ? 'bg-blue-600 text-white shadow-md' : 'text-slate-400 hover:text-white'
                }`}
            >
              Yearly Billing
          ...
          {plans.map((plan) => {
            ...
            return (
              <div
                ...
                className={`rounded-3xl p-6 space-y-5 flex flex-col justify-between transition cursor-pointer relative ${isSelected
              ...
              >
                ...
                <button
                  ...
                  className={`w-full py-2.5 rounded-xl text-xs font-bold transition cursor-pointer ${isSelected
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  <button
                    ...
                    className={`p-3 rounded-2xl border text-xs font-bold flex items-center justify-center gap-2 transition cursor-pointer ${paymentMethod === 'card'
                  ...
                  <button
                    ...
                    className={`p-3 rounded-2xl border text-xs font-bold flex items-center justify-center gap-2 transition cursor-pointer ${paymentMethod === 'upi'
                        ? 'bg-blue-600/30 border-blue-500 text-white'
                        : 'bg-slate-900/60 border-slate-700 text-slate-400 hover:text-white'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`p-3 rounded-2xl border text-xs font-bold flex items-center justify-center gap-2 transition cursor-pointer ${paymentMethod === 'netbanking'
                        ? 'bg-blue-600/30 border-blue-500 text-white'
                        : 'bg-slate-900/60 border-slate-700 text-slate-400 hover:text-white'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`p-3 rounded-2xl border text-xs font-bold flex items-center justify-center gap-2 transition cursor-pointer ${paymentMethod === 'wire'
                        ? 'bg-blue-600/30 border-blue-500 text-white'
                        : 'bg-slate-900/60 border-slate-700 text-slate-400 hover:text-white'
                      }`}
                  >
