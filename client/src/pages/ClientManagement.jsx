        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            <button 
              ...
              className={`flex items-center gap-2 px-5 py-2.5 bg-white border ${filterType !== 'All' ? 'border-blue-400 text-blue-600' : 'border-slate-200 text-slate-600'} rounded-xl text-xs font-black hover:bg-slate-50 transition-all shadow-sm`}
            >
              <Filter size={16} />
              {filterType === 'All' ? 'Filter' : filterType}
              <ChevronRight size={14} className={`transition-transform duration-300 ${showFilter ? '-rotate-90' : 'rotate-90'}`} />
            </button>
            {showFilter && (
