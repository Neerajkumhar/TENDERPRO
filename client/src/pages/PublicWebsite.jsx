        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 border-b border-slate-200 pb-4">
            <button
              ...
              className={`px-4 py-2.5 rounded-xl text-xs font-bold transition cursor-pointer ${activeSolutionTab === 'contractors'
            ...
            <button
              ...
              className={`px-4 py-2.5 rounded-xl text-xs font-bold transition cursor-pointer ${activeSolutionTab === 'subcontractors'
                ? 'bg-blue-600 text-white shadow-md'
                : 'bg-slate-100 text-slate-600 hover:bg-slate-200'
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-2.5 rounded-xl text-xs font-bold transition cursor-pointer ${activeSolutionTab === 'enterprises'
                ? 'bg-blue-600 text-white shadow-md'
                : 'bg-slate-100 text-slate-600 hover:bg-slate-200'
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-2.5 rounded-xl text-xs font-bold transition cursor-pointer ${activeSolutionTab === 'bidders'
                ? 'bg-blue-600 text-white shadow-md'
                : 'bg-slate-100 text-slate-600 hover:bg-slate-200'
                }`}
            >
            ...
            <div className="pt-3 flex items-center justify-center">
              <div className="bg-slate-100 p-1.5 rounded-full border border-slate-200 flex items-center gap-1 relative shadow-inner">
                <button
                  ...
                  className={`px-5 py-2 rounded-full text-xs font-bold transition cursor-pointer ${!isYearly ? 'bg-blue-600 text-white shadow-md' : 'text-slate-600 hover:text-slate-900'
                    }`}
                >
                  Monthly Billing
                </button>
                ...
                <button
                  ...
                  className={`px-5 py-2 rounded-full text-xs font-bold transition flex items-center gap-2 cursor-pointer ${isYearly ? 'bg-blue-600 text-white shadow-md' : 'text-slate-600 hover:text-slate-900'
                    }`}
                >
                  Yearly Billing
            ...
            {plans.map((plan) => {
              ...
              return (
                <div
                  ...
                  className={`rounded-2xl p-6 space-y-5 flex flex-col justify-between transition cursor-pointer relative ${plan.isPopular
                ...
                >
                  ...
                  <button
                    ...
                    className={`w-full py-3 rounded-2xl text-xs font-bold transition cursor-pointer ${plan.isPopular
