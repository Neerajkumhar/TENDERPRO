    ...
    <div className="bg-[#F8FAFC] animate-in fade-in duration-700">
      ...
      <div className="sticky top-0 z-50 bg-white border-b border-slate-100 px-8 py-4 flex justify-between items-center shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-black text-slate-900 tracking-tight">Initialize New Project</h1>
        </div>
        <div className="flex items-center gap-3">
          <button
            onClick={onCancel}
      ...
      <div className="max-w-[1400px] mx-auto px-8 py-8 grid grid-cols-12 gap-8">
            ...
            <div className="space-y-4">
              {sections.map((step) => (
                <button
                  ...
                  className={`w-full flex items-center gap-4 p-4 rounded-2xl transition-all text-left group ${activeStep === step.id
                ...
                >
                  ...
                  <div>
                    <h4 className={`text-sm font-black tracking-tight ${activeStep === step.id ? 'text-indigo-600' : 'text-slate-600'}`}>
                      {step.title}
                    </h4>
        ...
        <div className="col-span-12 lg:col-span-9 pb-20">
          <div className="animate-in slide-in-from-right-8 duration-500">
            ...
            {activeStep === 1 && (
              <div className="bg-white p-10 rounded-[2rem] shadow-2xl shadow-slate-200/40 space-y-10">
                <div className="flex items-center gap-4">
                  <div className="p-3 bg-indigo-600 text-white rounded-2xl shadow-lg shadow-indigo-100">
                    <Briefcase size={24} />
                  </div>
                  <div>
                    <h3 className="text-2xl font-black text-slate-900 tracking-tight">Project Identity</h3>
            ...
            {activeStep === 2 && (
              <div className="bg-white p-10 rounded-[2rem] shadow-2xl shadow-slate-200/40 space-y-10">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-slate-900 tracking-tight">Timeline & Status</h3>
            ...
            {activeStep === 3 && (
              <div className="bg-white p-10 rounded-[2rem] shadow-2xl shadow-slate-200/40 space-y-10">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-slate-900 tracking-tight">Scope of Work</h3>
            ...
            {activeStep === 4 && (
              <div className="bg-white p-10 rounded-[2rem] shadow-2xl shadow-slate-200/40 space-y-10">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-slate-900 tracking-tight">Financial Framework</h3>
            ...
            {activeStep === 5 && (
              <div className="bg-white p-10 rounded-[2rem] shadow-2xl shadow-slate-200/40 space-y-10">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-slate-900 tracking-tight">Resource Team</h3>
            ...
            {activeStep === 6 && (
              <div className="bg-white p-10 rounded-[2rem] shadow-2xl shadow-slate-200/40 space-y-10">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-slate-900 tracking-tight">Final Review</h3>
                ...
                <div className="bg-slate-50 rounded-[2.5rem] p-10 space-y-8 border border-slate-100">
                  <div className="flex justify-between items-center border-b border-slate-200 pb-6">
                    <div>
                      ...
                      <p className="text-lg font-black text-slate-800">{formData.title || 'Untitled Project'}</p>
                    </div>
                    <div className="text-right">
                      <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-1">TOTAL VALUE</p>
                      <p className="text-lg font-black text-indigo-600">₹{Number(formData.value).toLocaleString()}</p>
                    </div>
                  </div>
            ...
            <div className="flex justify-between items-center mt-12 bg-white p-6 rounded-[2.5rem] shadow-xl shadow-slate-200/30 border border-slate-50">
              ...
              {activeStep === sections.length ? (
                <button 
                  ...
                  className="flex items-center gap-3 px-10 py-4 bg-indigo-600 text-white rounded-2xl text-sm font-black hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-200 active:scale-95 uppercase tracking-widest group"
                >
                  <Flag size={18} />
                ...
                <button
                  onClick={handleNext}
                  className="flex items-center gap-3 px-10 py-4 bg-indigo-600 text-white rounded-2xl text-sm font-black hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-200 active:scale-95 uppercase tracking-widest"
                >
                  <span>Next Step</span>
