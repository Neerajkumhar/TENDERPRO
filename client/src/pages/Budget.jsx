        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="relative">
            <button 
              ...
              className={`flex items-center gap-2 px-4 sm:px-6 py-3.5 rounded-2xl text-[10px] sm:text-[11px] font-black uppercase tracking-widest transition-all shadow-sm border ${showGlobalFilter ? 'bg-blue-600 text-white border-blue-600' : 'bg-white text-slate-600 border-slate-100 hover:bg-slate-50'}`}
            >
              <Filter size={18} />
            ...
            {showGlobalFilter && (
              <div className="absolute right-0 mt-3 w-[280px] sm:w-[320px] bg-white border border-slate-100 shadow-2xl rounded-[1.5rem] sm:rounded-[2rem] p-6 z-[100] animate-in fade-in zoom-in-95 duration-200">
                <div className="flex justify-between items-center mb-6">
                  <h4 className="text-[10px] sm:text-xs font-black text-slate-900 uppercase tracking-widest">Active Filters</h4>
                  <button 
                    onClick={() => {
                      setStatusFilter('ALL');
                    ...
                    className="text-[8px] sm:text-[9px] font-black text-blue-600 uppercase tracking-widest hover:underline"
                  >
                    Reset All
                  </button>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="text-[9px] sm:text-[10px] font-black text-slate-400 uppercase tracking-widest">Budget Status</span>
                    </div>
                    <div className="grid grid-cols-2 gap-2">
                      {['ALL', 'ON TRACK', 'OVER BUDGET', 'UNDER BUDGET'].map(status => (
                        <button
                          ...
                          className={`py-2 px-1 rounded-xl text-[8px] sm:text-[9px] font-black transition-all ${statusFilter === status ? 'bg-blue-600 text-white shadow-md shadow-blue-100' : 'bg-slate-50 text-slate-500 hover:bg-slate-100'}`}
                        >
                          {status}
                        </button>
                      ))}
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="text-[9px] sm:text-[10px] font-black text-slate-400 uppercase tracking-widest">Department</span>
                    </div>
                    <select 
                      className="w-full px-4 py-2.5 bg-slate-50 border border-slate-100 rounded-xl text-[9px] sm:text-[10px] font-black uppercase tracking-widest outline-none focus:ring-2 focus:ring-blue-500/20"
                  ...
                  <button 
                    ...
                    className="w-full py-3.5 bg-slate-900 text-white rounded-2xl text-[10px] sm:text-[11px] font-black uppercase tracking-widest hover:bg-slate-800 transition-all shadow-lg"
                  >
                    Apply Filters
                  </button>
                </div>
