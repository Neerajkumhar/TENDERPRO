          ...
          <div key={member.id} className="bg-white p-6 sm:p-8 rounded-[2.5rem] sm:rounded-[3rem] border border-slate-50 shadow-sm hover:shadow-2xl transition-all duration-500 group overflow-hidden relative">
             ...
             <div className="flex justify-between items-start mb-6 sm:mb-8">
                <div className="relative">
                   <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl sm:rounded-[2rem] bg-slate-100 border-4 border-white shadow-xl flex items-center justify-center text-xl sm:text-2xl font-black text-slate-400 transition-all group-hover:scale-105 group-hover:rotate-3 overflow-hidden">
                ...
                <div className="flex gap-2">
                   <div className="relative">
                      <button className="p-2 sm:p-3 bg-slate-50 text-slate-300 hover:text-blue-600 hover:bg-blue-50 rounded-xl sm:rounded-2xl transition-all">
             ...
             <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8">
                <div className="p-3 sm:p-4 bg-slate-50 rounded-2xl sm:rounded-3xl border border-slate-50 transition-all group-hover:border-slate-100 group-hover:bg-white">
                   ...
                   <p className="text-[10px] sm:text-xs font-black text-slate-700 uppercase truncate">{member.departmentId ? 'Team Dept' : 'Unassigned'}</p>
                </div>
                <div className="p-3 sm:p-4 bg-slate-50 rounded-2xl sm:rounded-3xl border border-slate-50 transition-all group-hover:border-slate-100 group-hover:bg-white">
                   <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-1">Projects</p>
                   <p className="text-[10px] sm:text-xs font-black text-slate-700 uppercase">4 Active</p>
                </div>
             </div>
